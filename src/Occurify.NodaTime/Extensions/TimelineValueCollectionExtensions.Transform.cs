...
public static partial class TimelineValueCollectionExtensions
{
    ...
    /// </summary>
    public static Dictionary<ITimeline, TValue> Offset<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, Duration offset) =>
    ...
    /// </summary>
    public static Dictionary<ITimeline, TValue> Randomize<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, Duration maxDeviation) =>
    ...
    /// </summary>
    public static Dictionary<ITimeline, TValue> Randomize<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, int seed, Duration maxDeviation) =>
    ...
    /// This method will never result in a change of instant count or in overlapping instants in each timeline.
    /// </summary>
    public static Dictionary<ITimeline, TValue> Randomize<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, Duration maxDeviationBefore, Duration maxDeviationAfter) =>
    ...
    /// </summary>
    public static Dictionary<ITimeline, TValue> Randomize<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, int seed, Duration maxDeviationBefore, Duration maxDeviationAfter) =>
    ...
    /// Identical inputs with the same <paramref name="seed"/>, will result in the same output.
    /// </summary>
    public static Dictionary<ITimeline, TValue> Randomize<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, int seed, Duration maxDeviationBefore, Duration maxDeviationAfter, Func<int, double> randomFunc) =>
