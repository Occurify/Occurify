...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TimelineSample"/> class.
    /// </summary>
    public TimelineSample(DateTime utcSampleInstant, bool sampleIsInstant, DateTime? previous, DateTime? next)
    {
