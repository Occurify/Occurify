...
public static partial class TimelineKeyCollectionExtensions
{
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> Offset<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, TimeSpan offset) where TKey : notnull =>
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> OffsetTicks<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, long ticks) where TKey : notnull =>
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> OffsetMicroseconds<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, double microseconds) where TKey : notnull =>
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> OffsetMilliseconds<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, double milliseconds) where TKey : notnull =>
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> OffsetSeconds<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, double seconds) where TKey : notnull =>
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> OffsetMinutes<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, double minutes) where TKey : notnull =>
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> OffsetHours<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, double hours) where TKey : notnull =>
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> OffsetDays<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, double days) where TKey : notnull =>
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> Randomize<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, TimeSpan maxDeviation) where TKey : notnull =>
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> Randomize<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, int seed, TimeSpan maxDeviation) where TKey : notnull =>
    ...
    /// This method will never result in a change of instant count or in overlapping instants in each timeline.
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> Randomize<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, TimeSpan maxDeviationBefore, TimeSpan maxDeviationAfter) where TKey : notnull =>
    ...
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> Randomize<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, int seed, TimeSpan maxDeviationBefore, TimeSpan maxDeviationAfter) where TKey : notnull =>
    ...
    /// Identical inputs with the same <paramref name="seed"/>, will result in the same output.
    /// </summary>
    public static IEnumerable<KeyValuePair<TKey, ITimeline>> Randomize<TKey>(this IEnumerable<KeyValuePair<TKey, ITimeline>> source, int seed, TimeSpan maxDeviationBefore,
