...
public static class TimelineValueCollectionExtensions
{
    ...
    /// </summary>
    public static IObservable<Unit> ToPulseObservable<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, IScheduler scheduler) =>
    ...
    /// </summary>
    public static IObservable<Unit> ToPulseObservable<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, DateTime relativeTo, IScheduler scheduler) =>
    ...
    /// </summary>
    public static IObservable<DateTime> ToInstantObservable<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, IScheduler scheduler) =>
    ...
    /// </summary>
    public static IObservable<DateTime> ToInstantObservable<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, DateTime relativeTo, IScheduler scheduler) =>
    ...
    /// </summary>
    public static IObservable<DateTime> ToInstantObservableIncludingCurrentInstant<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, IScheduler scheduler)
    {
    ...
    /// </summary>
    public static IObservable<DateTime> ToInstantObservableIncludingCurrentInstant<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, DateTime relativeTo, IScheduler scheduler)
    {
    ...
    /// </summary>
    public static IObservable<TimelineValueCollectionSample<TValue>> ToSampleObservable<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, IScheduler scheduler) =>
    ...
    /// </summary>
    public static IObservable<TimelineValueCollectionSample<TValue>> ToSampleObservable<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, DateTime relativeTo, IScheduler scheduler)
    {
    ...
    /// </summary>
    public static IObservable<TimelineValueCollectionSample<TValue>> ToSampleObservableIncludingCurrentInstant<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, IScheduler scheduler)
    {
        source = source.ToArray();
        return Observable.Defer(() =>
        {
    ...
    /// </summary>
    public static IObservable<TimelineValueCollectionSample<TValue>> ToSampleObservableIncludingCurrentInstant<TValue>(this IEnumerable<KeyValuePair<ITimeline, TValue>> source, DateTime relativeTo, IScheduler scheduler)
    {
        source = source.ToArray();
